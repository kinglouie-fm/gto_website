          ...
          <div class="form h-100 contact-wrap p-5">
            ...
            <form class="mt-5" @submit.prevent="sendEmail">
              <div class="row">
                ...
                <!-- Email input -->
                <div class="form-floating mb-3">
                  <input class="form-control" type="email" v-model="email" name="email" placeholder="Email Address"
                    required />
              ...
              <div class="row mb-5">
                <div class="form-floating mb-3">
                  <textarea class="form-control" type="text" v-model="message" name="message" placeholder="Message"
                    required style="height: 10rem;"></textarea>
                  <label>Message</label>
                </div>
              </div>
